      ...
      {itemsCount > 0 ? (
        <ul className="flex flex-col gap-6 w-full">
          ...
          <div className="w-full flex gap-4 items-center justify-between mt-8 px-8 bg-green-100 h-20 rounded-xl">
            <h3 className="font-sempione text-2xl ">
              Subtotal: {subtotal.toFixed(2)} $
            </h3>
            <button className="bg-blue-500 hover:bg-blue-600 active:bg-blue-700 focus:ring focus:ring-blue-200 text-zinc-50 rounded-xl px-4 p-2">
              Checkout
            </button>
          </div>
        </ul>
      ) : (
        <div className="w-full flex gap-4 items-center mt-8 px-8 bg-orange-100 text-orange-500 h-20 rounded-xl">
          <h3 className="font-sempione text-2xl ">Your cart is empty.</h3>
